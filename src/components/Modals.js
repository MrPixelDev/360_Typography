...
export const ModalOrder = (props) => {
  return (
    <div onClick={props.trigger} id="modalorder" className="modal">
      <div className="modal-content">
        ...
        <div className="modal-body">
          <p>
            Для получения подробной информации обратитесь в WhatsApp по номеру
            телефона:
          </p>
          <br />
          <p>{configData.whatsapp}</p>
          <br />
          <p>Либо позвоните по данному номеру</p>
        </div>
        <div
          onClick={() => {
...
export const ModalConfident = (props) => {
  return (
    <div onClick={props.trigger} id="modalconfident" className="modal">
      <div className="modal-content">
        <div className="modal-header">
          <span className="close">&times;</span>
        ...
        <div className="modal-body">
          ...
          <p>
            ...
            данных, предпринимаемые ООО Рекламный партнер (далее – Оператор).
          </p>
          <p>
          ...
          <p>
            ...
            доступность в сети интернет по сетевому адресу {configData.site};
          </p>
          <p>
          ...
          <p>
            2.9. Пользователь – любой посетитель веб-сайта {configData.site};
          </p>
          <p>
          ...
          <p>
            ...
            электронной почты {configData.email} с пометкой «Отказ от
          ...
          <p>
            ...
            через специальные формы, расположенные на сайте {configData.site}.
          ...
          <p>
            ...
            Оператора {configData.email} с пометкой «Актуализация персональных
            данных».
          </p>
          <p>
            ...
            {configData.email} с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          ...
          <p>
            ...
            к Оператору с помощью электронной почты {configData.email}.
          </p>
          <p>
